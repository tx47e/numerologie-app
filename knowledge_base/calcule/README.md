...
Acest director contine baza de lucru pentru formule, metode, interpretari si
exemple de calcul numerologic.

Scopul este sa pastram separat:

- metoda de calcul;
- semnificatia rezultatului;
- exemplele concrete;
- observatiile necesare pentru implementarea ulterioara in aplicatie.
