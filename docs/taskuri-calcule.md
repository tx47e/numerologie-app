...
| [x] | Lectii karmice personale | de revizuit; documentat; implementat | Metoda si exemple dedicate adaugate; implementat in script. | Adauga semnificatii detaliate pentru numerele lipsa. |
| [x] | Datorii karmice personale | de revizuit; documentat; implementat | Metoda si exemple dedicate adaugate; implementat in script. | Valida editorial daca datoriile se verifica si pe totalurile componentelor numelui. |
