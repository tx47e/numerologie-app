...
| [x] | Karma personala | de revizuit; documentat; implementat | Metoda actualizata ca profil combinat din data nasterii si numele complet; exemple dedicate adaugate; implementat in script. | Adauga semnificatii detaliate pentru straturile din data si nume. |
| [x] | Lectii karmice personale | de revizuit; documentat; implementat | Metoda si exemple dedicate adaugate ca strat din nume in karma personala; implementat in script. | Adauga semnificatii detaliate pentru numerele lipsa. |
| [x] | Datorii karmice personale | de revizuit; documentat; implementat | Metoda si exemple dedicate adaugate ca strat din data si nume; implementat in script. | Valida editorial daca datoriile se verifica si pe totalurile componentelor numelui. |
